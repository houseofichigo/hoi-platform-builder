...
// NOTE: Extracted Map Process (DiagramStep) + helpers — standalone.
// Peer deps required by host project:
//   npm: react, @xyflow/react, lucide-react, @tanstack/react-query
//   local @/ modules: components/ui/*, components/build/pfs/{process-template-library,risk-tier-badge,tool-catalog-picker},
//     lib/diagram-patch, lib/db/pfs/*, lib/node-field-schema, lib/risk-tier,
//     lib/scoring/process-score, lib/process-data
