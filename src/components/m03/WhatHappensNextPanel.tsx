  ...
  return (
    <section className="mx-auto max-w-[780px] rounded-lg border border-chalk bg-mist/70 p-6 space-y-4">
      ...
      <p className="text-[14px] leading-relaxed text-graphite">
        This Playbook is your prompt automation toolkit. Open it next week and run your first Rung{" "}
        {currentRung} ({RUNG_LABELS[currentRung]}) workflow with real source rules and human review.
      </p>
    </section>
  );
}
