...
export const MODULES: ModuleMeta[] = [
  ...
  },
  {
    ...
    description: 'Identify internal, contextual and task-specific data sources; apply ownership, lineage, quality and access governance; classify by Saudi-market regime (PDPL, NDMO, SDAIA, NCA/SAMA where relevant).',
    objectives: [
      'Identify data sources: Internal, Contextual, Task-specific',
      'Apply governance: Ownership, Lineage, Quality, Access',
      'Classify data by Saudi-market regime (PDPL, NDMO, SDAIA, NCA/SAMA where relevant)',
  ...
  },
  {
    ...
    description: 'Document the AI system at three layers: architecture, decisions, and governance. Write a system card aligned with Saudi AI governance expectations, produce a non-engineer operating playbook, and design a five-stage handoff process.',
    objectives: [
      'Document AI at three layers: architecture, decisions, governance',
      'Write a system card aligned with SDAIA, PDPL, and NDMO expectations',
    ...
    concepts: [
      ...
      { term: 'Saudi AI governance documentation', definition: 'High-impact AI documentation patterns: intended purpose, data, validation, monitoring, human oversight, risk controls, PDPL posture, and change management.' },
