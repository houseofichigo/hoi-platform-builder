...
export const MODULES: ModuleMeta[] = [
  ...
  },
  {
    ...
    objectives: [
      ...
      'Map internal, contextual, and task-specific knowledge for any use case',
      'Build knowledge base entries with metadata',
      'Define ownership, lineage, access, sensitivity, and refresh rules',
      'Test whether the AI can retrieve the right knowledge',
    ...
    keySections: [
      ...
      'Governance and retrieval quality',
      'Gate 1 readiness',
    ...
    concepts: [
      ...
      { term: 'Knowledge entry', definition: 'A structured entry with title, layer, source, owner, rule or fact, tags, sensitivity, status, and refresh rule.' },
      { term: 'Three knowledge layers', definition: 'Internal knowledge, contextual knowledge, and task-specific knowledge: the minimum map every AI use case needs.' },
      { term: 'Retrieval test', definition: 'A question the AI should answer from the knowledge base, with expected entry, source, and limitation.' },
    ],
    assignment: 'Build a three-layer knowledge base blueprint. Select sources, create five knowledge-entry categories, write retrieval tests, and assign a Gate 1 data + knowledge readiness status.',
    outcome: 'A source-backed knowledge base blueprint with metadata, retrieval tests, governance checks, and named gaps before Build.',
  },
  {
