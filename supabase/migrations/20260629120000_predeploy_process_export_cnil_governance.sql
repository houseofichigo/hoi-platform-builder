-- Pre-deployment compatibility pass for Build exports and Scale governance.
-- Keeps the Path A legacy bridge intact while making the new process-led flow
-- safe to approve, export, and govern.
